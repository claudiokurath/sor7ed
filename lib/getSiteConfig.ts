...
const DEFAULT_CONFIG: Record<string, { text: string; color: string; image: string; active: boolean }> = {
  ...
  home_bg_color: { text: '', color: '#0a0a0a', image: '', active: true },
  home_accent_color: { text: '', color: '#d4af37', image: '', active: true },
  home_accent_sec_color: { text: '', color: '#b8941f', image: '', active: true },
  ...
  explore_bg_color: { text: '', color: '#0a0a0a', image: '', active: true },
  explore_accent_color: { text: '', color: '#d4af37', image: '', active: true },
  ...
  tools_bg_color: { text: '', color: '#0a0a0a', image: '', active: true },
  tools_accent_color: { text: '', color: '#d4af37', image: '', active: true },
  ...
  intelligence_bg_color: { text: '', color: '#0a0a0a', image: '', active: true },
  intelligence_accent_color: { text: '', color: '#d4af37', image: '', active: true },
};
