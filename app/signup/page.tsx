        ...
        <form action={formAction} className="space-y-5">
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0a0a0a] px-4 text-white/20 tracking-widest font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <motion.button
            ...
            disabled={status === 'loading'}
            className="w-full bg-white/5 border border-white/10 text-white font-bold py-4 rounded-xl hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50"
            whileHover={{ scale: status === 'loading' ? 1 : 1.01 }}
            whileTap={{ scale: 0.98 }}
          >
