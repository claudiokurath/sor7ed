  ...
  const heroBanner = (
    <section className="relative w-full min-h-[50vh] flex items-end overflow-hidden">
      <div className="absolute inset-0">
        <img src="/Images/home/u1886598145_neurodiversity_--ar_169_--raw_--sref_httpss.mj.ru_411dc7a7-ffa1-4b3a-b81e-ab0deecf3fd0_2.png" alt="Sign in banner" className="absolute inset-0 w-full h-full object-cover" />
