...
async function main() {
  try {
    console.log(`Starting bulk Notion database update for lyric style tags...`);
    let hasMore = true;
    ...
    while (hasMore) {
      ...
      for (const page of response.results) {
        ...
        const updatedLyrics = replaceTags(lyricsText);
    ...
    console.log(`\nBulk update complete! Successfully updated ${totalUpdated} songs in Notion.`);
